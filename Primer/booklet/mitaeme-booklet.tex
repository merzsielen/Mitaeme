...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item man le peinta-hase ta-ye te auto — \textsc{1sg pfv} paint-\textsc{vb} pl-3 \textsc{gen} car \\\textit{I painted their cars.}
	\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{\textit{man-man}} / \textbf{\textit{mamman}} — \textit{pronoun}, ``we (exclusive)'' — There are two forms of ``we'' in Mitaeme; the first, $\langle$man-man$\rangle$, is exclusive, meaning it does not include the listener. For example, if you were talking to someone about how you and your friends went somewhere, you would use $\langle$man-man$\rangle$, but if the person you were speaking to was also there, then you would use the inclusive form, $\langle$man-ni$\rangle$.
	\begin{itemize}
		\item man-man hafe kai auto — 1\textasciitilde{}\textsc{pl} have many car \\\textit{We have many cars.}
	\end{itemize}
	\item \textbf{\textit{man-ni}} /  \textbf{\textit{manni}} — \textit{pronoun}, ``we (inclusive)'' — This version of ``we'' is inclusive, meaning it includes the listener.
	\begin{itemize}
		\item so man-ni mita (mita) — \textsc{aff 1+2pl} friend(\textasciitilde{}\textsc{pl}) \\\textit{Yes, we are friends.}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item man le kome hafe yena naife pa ke ni kata keike — \textsc{1sg pfv} come have \textsc{medi} knife \textsc{instr rel 2sg} cut cake \\\textit{I brought the knife with which you cut the cake.}
	\end{itemize}
	...
	\begin{itemize}
		\item man le ale a kasa — \textsc{1sg incho} go \textsc{loc} house /  \textsc{1sg pfv} go \textsc{loc} house  \\\textit{I am going home. / I went home.}
		\item ye (man te) mita le — \textsc{3sg (1sg gen)} friend \textsc{trans} \\\textit{He has become my friend. / He became my friend.}
	\end{itemize}
	...
	\begin{itemize}
		\item man le hase ca o ni — \textsc{1sg pfv} do \textsc{purp 2sg} \\\textit{I made tea for you.}
		\item ta ni palu-hase kau kau  — \textsc{pl-2} milk-\textsc{vb} cow\textasciitilde{}\textsc{pl} \\\textit{You all are all milking the cows.}
		\item man le hase ni tewa pensi a ye — \textsc{1sg pfv caus} \textsc{2sg} give pencil \textsc{dat 3sg} \\\textit{I made you give the pencil to her.}
		\item mna le sahin-hase ni te ca — \textsc{1sg pfv} hot-\textsc{vb} \textsc{2sg gen} tea \\\textit{I warmed-up your tea.}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item ni le tewa cokolate a man — \textsc{1sg pfv} give chocolate \textsc{dat 1sg} \\\textit{You gave me chocolate.}
	\end{itemize}
	...
	\begin{itemize}
		\item man le ale a kasa i ye ci — \textsc{1sg pfv} go \textsc{loc} house \textsc{conj 3sg} eat \\\textit{I went home and he ate.}
	\end{itemize}
\end{itemize}
